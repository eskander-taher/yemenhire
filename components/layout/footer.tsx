      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="col-span-1 md:col-span-2">
            <Link href={`/${locale}`} className="flex items-center space-x-3 rtl:space-x-reverse mb-6 group">
            ...
            <p className="text-gray-300 mb-6 max-w-md leading-relaxed text-lg">{dict.footer.description}</p>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-xl font-bold mb-6 text-white">{dict.footer.quickLinks}</h3>
