            ...
            <CardHeader>
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <CardTitle className="text-2xl font-bold text-gray-900 mb-2">{tender.title}</CardTitle>
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader className="text-center">
              ...
              <p className="text-sm text-gray-600">{tender.category || "Organization"}</p>
            </CardHeader>
          </Card>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-center">Tender Submission</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <p className="text-sm text-gray-600 text-center">Click the button below to submit your proposal</p>
              {tender.contactEmail ? (
          ...
          {daysRemaining !== null && (
            <Card>
              ...
              <CardContent className="text-center">
                ...
                {tender.deadline && <p className="text-xs text-gray-500 mt-2">Deadline: {formatDate(tender.deadline)}</p>}
              </CardContent>
            </Card>
          )}
